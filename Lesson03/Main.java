...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            Human people = menu.inputMenu();
            System.out.println("Вы ввели: " + people.toString());
            WorkingFiles fw = new WorkingFiles(people);
            fw.fileWrite(people);
        } catch (MyFileNotFoundException | StringParsingException var4) {
